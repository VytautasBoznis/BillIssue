...
{
    public class GetAllProjectWorktypesOperation : BaseOperation<GetAllProjectWorktypesRequest, GetAllProjectWorktypesResponse>
    {
        private readonly IProjectRepository _projectRepository;

        public GetAllProjectWorktypesOperation(
            ILogger<GetProjectWorktypeOperation> logger,
            IUnitOfWorkFactory unitOfWorkFactory, 
            OperationFactory operationFactory, 
            IValidator<GetAllProjectWorktypesRequest> validator,
            IProjectRepository projectRepository) : base(logger, unitOfWorkFactory, operationFactory, validator)
        {
            _projectRepository = projectRepository;
        }

        protected override async Task<GetAllProjectWorktypesResponse> Execute(GetAllProjectWorktypesRequest request, IUnitOfWork unitOfWork)
        {
            ...
            List<ProjectWorktypeDto> projectWorktypeDtos = await _projectRepository.GetProjectWorktypeDtos(request.ProjectId, unitOfWork);

            return new GetAllProjectWorktypesResponse
            {
                ProjectWorktypeDtos = projectWorktypeDtos,
            };
        }
    }
}
