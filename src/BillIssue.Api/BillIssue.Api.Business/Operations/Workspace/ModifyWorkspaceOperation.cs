...
{
    public class ModifyWorkspaceOperation : BaseOperation<ModifyWorkspaceRequest, ModifyWorkspaceResponse>
    {
        private readonly IWorkspaceRepository _workspaceRepository;

        public ModifyWorkspaceOperation(
            ILogger<ModifyWorkspaceOperation> logger,
            IUnitOfWorkFactory unitOfWorkFactory,
            OperationFactory operationFactory, 
            IValidator<ModifyWorkspaceRequest> validator,
        ...
        protected override async Task<ModifyWorkspaceResponse> Execute(ModifyWorkspaceRequest request, IUnitOfWork unitOfWork)
        {
            ...
            workspaceResponse.WorkspaceDto.Name = request.Name;
            workspaceResponse.WorkspaceDto.Description = request.Description;

            await _workspaceRepository.ModifyWorkspaceInTransaction(request.SessionUserData.Id, request.SessionUserData.Email, workspaceResponse.WorkspaceDto, unitOfWork);
            ...
            {
                WorkspaceDto = updatedWorkspaceResponse.WorkspaceDto
            };
        }
    }
}
